...
(() => {
  ...
  // src/webview/diffPanelScript.ts
  ...
  function highlightLine(code, lang) {
    const grammar = import_prismjs.default.languages[LANG_MAP[lang] ?? "javascript"];
    if (!grammar) return escapeHtml(code);
    return import_prismjs.default.highlight(code, grammar, LANG_MAP[lang] ?? "javascript");
  }
  function escapeHtml(str) {
    return str.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
  }
  function renderDiff(unified, lang) {
